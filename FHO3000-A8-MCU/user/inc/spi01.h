...
#define WIFI_CS_PORT              GPIOB
#define WIFI_CS_CLK               RCC_APB2Periph_GPIOB 
#define WIFI_CS_PIN               GPIO_Pin_12
#define WIFI_CS_Dis()             { GPIO_SetBits(WIFI_CS_PORT,WIFI_CS_PIN); }
#define WIFI_CS_EN()              { GPIO_ResetBits(WIFI_CS_PORT,WIFI_CS_PIN);}
